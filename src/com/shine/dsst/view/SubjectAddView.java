...
public class SubjectAddView extends JFrame {
...
//	}
	...
	public SubjectAddView() {
		...
		JLabel label = new JLabel("请输入要添加的试题信息");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Subject subject = new Subject(null,title,a,b,c,d,src,as,subjectType);
				boolean temp = subjectService.AddSubject(subject);
				if(temp) {
					SubjectView frame = new SubjectView();
					frame.setVisible(true);
					SubjectAddView.this.dispose();
				}
			}
		});
